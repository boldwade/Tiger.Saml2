...
public static class IServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddCors(x =>
        {
            x.AddDefaultPolicy(blah =>
            {
                blah.WithOrigins("https://login.microsoftonline.com", "https://localhost:44318", "https://localhost:44373", "https://localhost:44301", "https://localhost:44476")
                    .AllowCredentials()
                    .AllowAnyMethod()
